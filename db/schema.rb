...
ActiveRecord::Schema[8.1].define(version: 2026_01_09_201137) do
  ...
  create_table "organization_units", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.float "longitude"
    t.string "name"
    t.uuid "organization_type_id", null: false
    t.string "ownership"
    t.uuid "parent_organization_unit_id"
    t.string "phone"
    t.string "short_name"
    t.datetime "updated_at", null: false
    t.string "url"
    ...
    t.index ["parent_organization_unit_id"], name: "index_organization_units_on_parent_organization_unit_id"
  end

  create_table "partner_types", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "description"
    t.string "name"
    t.datetime "updated_at", null: false
  ...
  create_table "partners", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "email"
    t.string "name"
    t.uuid "partner_type_id", null: false
    t.string "phone"
    t.string "short_name"
    t.string "status"
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "organization_units", "organization_units", column: "parent_organization_unit_id"
